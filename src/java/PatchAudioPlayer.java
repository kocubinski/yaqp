 ...
 *
 */
public class PatchAudioPlayer implements AudioPlayer {
    ...
    private Semaphore patchSempahore = new Semaphore(1);
	...
	DataLine.Info info = new DataLine.Info(SourceDataLine.class, format);
		...
		patchSempahore.acquire();
		patchSempahore.acquire();
		opened = true;
		patchSempahore.release();
